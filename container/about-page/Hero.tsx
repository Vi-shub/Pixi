    ...
    <section className="w-full min-h-screen">
                ...
                <div className="w-[50%] flex flex-col gap-y-[40px] sm:w-full xm:w-full">
                  <div className="flex flex-col gap-y-[20px]">
                    <p className="paragraph font-NeueMontreal text-secondry">
                      At Pixavia, creativity meets precision. We are a
                      cutting-edge design studio dedicated to transforming ideas
                      into stunning visual masterpieces. From concept to
                      execution, we craft compelling visuals that make an
                      impact.
                    </p>
                  </div>
                  <div className="flex flex-col gap-y-[20px]">
                    <p className="paragraph font-NeueMontreal text-secondry">
                      Specializing in video editing, graphic design, branding,
                      3D modeling, and motion graphics, our team blends artistic
                      innovation with seamless workflow. Whether shaping brand
                      identities or producing dynamic visuals, Pixavia is your
                      partner in design excellence.
                    </p>
                  </div>
                </div>
      ...
      <div className="padding-x">
        <h1 className="sub-heading font-medium font-NeueMontreal text-secondry">
          We transform ideas into visually stunning
          <br className="sm:hidden xm:hidden" /> and impactful designs.
        </h1>
      </div>
    </section>
  );
